const sw = {
  ...
  newsManageHomepageRank: "Nafasi ya homepage",
  newsManageOpenIssues: "Issues wazi",
  newsManagePredictionReview: "Mapitio ya prediction",
  newsManagePredictionReviewTitle: "Mapitio ya editorial ya predictions",
  newsManagePredictionPending: "Inasubiri mapitio",
  newsManagePredictionApproved: "Imeidhinishwa",
  newsManagePredictionHold: "Shikilia",
  newsManagePredictionPublishedCount: "Predictions zilizochapishwa",
  newsManagePredictionPublished: "Imechapishwa",
  newsManagePredictionDraft: "Draft",
  newsManagePredictionTitle: "Kichwa cha prediction",
  newsManagePredictionType: "Aina ya recommendation",
  newsManagePredictionSummary: "Muhtasari wa prediction",
  newsManagePredictionSelection: "Lebo ya selection",
  newsManagePredictionMarket: "Aina ya market",
  newsManagePredictionConfidence: "Confidence",
  newsManagePredictionEdge: "Alama ya edge",
  newsManagePredictionPublishedAt: "Muda wa kuchapisha",
  newsManagePredictionExpiresAt: "Muda wa kuisha",
  newsManagePredictionReviewStatus: "Hali ya mapitio",
  newsManagePredictionPublishedToggle: "Chapisha recommendation",
  newsManagePredictionReviewNotes: "Maelezo ya mapitio",
  newsManagePredictionSave: "Hifadhi mapitio ya prediction",
  newsManagePredictionSaved: "Mapitio ya prediction yamehifadhiwa.",
  newsManagePredictionSaveFailed: "Imeshindikana kuhifadhi mapitio ya prediction.",
  adminEyebrow: "Admin",
  adminControlRoomTitle: "Chumba cha udhibiti cha admin",
  adminControlRoomLead:
    "Mwonekano wa uendeshaji, vidhibiti vya dharura, usalama wa editorial, na audit isiyobadilika kutoka sehemu moja.",
  adminControlRoomAccessRequired:
    "Ufikiaji wa admin unahitajika kuendesha control plane.",
  adminAdminsCount: "Admins",
  adminProvidersCount: "Providers",
  adminOpenIssuesCount: "Issues wazi",
  adminCacheAttentionCount: "Tahadhari ya cache",
  adminDrillsCount: "Drills 24h",
  adminCommercialAttentionCount: "Tahadhari ya biashara",
  adminStepUpLabel: "Nenosiri la uhakiki wa admin",
  adminStepUpPlaceholder: "Weka tena nenosiri kwa vitendo nyeti",
  adminStepUpRefresh: "Onyesha upya uhakiki wa admin",
  adminStepUpVerifying: "Inahakiki...",
  adminStepUpSuccess: "Uhakiki wa admin umeonyeshwa upya kwa dakika chache zijazo.",
  adminStepUpError: "Uhakiki umeshindikana.",
  adminRevenueEyebrow: "Mapato",
  adminRevenueTitle: "Vidhibiti vya affiliate, funnel, na placement",
  adminClicks24h: "Mibofyo 24h",
  adminQualifiedConversions24h: "Conversions zilizohitimu",
  adminConversionRate: "Kiwango cha conversion",
  adminAdReadiness: "Mapengo ya utayari wa ads",
  adminSurfaceTraffic: "Traffic ya kibiashara kwa surface",
  adminMappings: "Mappings",
  adminPredictions: "Predictions",
  adminUnassigned: "Haijapangwa",
  adminName: "Jina",
  adminShortName: "Jina fupi",
  adminWebsite: "Tovuti",
  adminAffiliateBase: "Affiliate base URL",
  adminBookmakerActive: "Bookmaker yuko hai",
  adminBookmakerSaved: "Bookmaker amesasishwa.",
  adminSaveBookmaker: "Hifadhi bookmaker",
  adminNoBookmaker: "Hakuna bookmaker",
  adminTerritory: "Eneo",
  adminSurface: "Surface",
  adminDestinationUrl: "Destination URL",
  adminFallbackUrl: "Fallback URL",
  adminDefaultRoute: "Njia ya msingi",
  adminAffiliateActive: "Affiliate CTA iko hai",
  adminPriority: "Kipaumbele",
  adminAffiliateSaved: "Njia ya affiliate imesasishwa.",
  adminSaveAffiliate: "Hifadhi njia ya affiliate",
  adminTitleLabel: "Kichwa",
  adminCtaLabel: "Lebo ya CTA",
  adminEnabledGeos: "Geos zilizowashwa",
  adminFunnelActive: "Njia ya funnel iko hai",
  adminFunnelSaved: "Njia ya funnel imesasishwa.",
  adminSaveFunnel: "Hifadhi njia ya funnel",
  adminNoLinkedTarget: "Hakuna target iliyounganishwa",
  adminDescription: "Maelezo",
  adminStartsAt: "Huanzia",
  adminEndsAt: "Huisha",
  adminPlacementActive: "Placement iko hai",
  adminPlacementSaved: "Placement imesasishwa.",
  adminSavePlacement: "Hifadhi placement",
  adminSummary: "Muhtasari",
  adminReviewStatus: "Hali ya mapitio",
  adminPredictionPublished: "Prediction imechapishwa",
  adminReviewNotes: "Maelezo ya mapitio",
  adminPredictionSaved: "Mapitio ya prediction yamesasishwa.",
  adminSavePrediction: "Hifadhi mapitio ya prediction",
  adminSelectedProvider: "Provider aliyechaguliwa",
  adminFallbackChain: "Mlolongo wa fallback",
  adminNoFallbackProviders: "Hakuna providers za fallback zilizowekwa.",
  adminCatalogCoverage: "Ufunikaji wa catalog",
  adminCatalogImplemented: "Imetekelezwa",
  adminCatalogPending: "Inasubiri",
  homeNotice:
  ...
  communitySlipsEyebrow: "Slips za jamii",
  communitySlipsTitle: "Fuata kile jamii inapendelea",
  communitySlipsLead:
    "Slips za umma na predictions sasa zimewekwa mbele kabisa ili wageni warudi kwa picks mpya, kulinganisha mawazo, na kuchapisha yao wenyewe.",
  communitySlipsPublicCount: "Slips za umma",
  ...
  communitySlipsSaveFailed: "Imeshindikana kuhifadhi slip yako.",
  communitySlipsPublishedMessage: "Slip imechapishwa kwenye feed ya jamii.",
  communitySlipsSavedMessage: "Slip imehifadhiwa kwenye drafts zako.",
  communitySlipsLikeFailed: "Imeshindikana kusasisha reaction yako.",
  ...
  communitySlipsComposerSummaryLabel: "Kwa nini slip hii?",
  ...
  communitySlipsUpdatePublished: "Sasisha na uchapishe",
  communitySlipsPublish: "Chapisha slip",
  communitySlipsResetComposer: "Weka upya",
  communitySlipsSignInTitle: "Watumiaji waliosajiliwa wanaweza kuhifadhi na kuchapisha slips",
  ...
  communitySlipsEmpty: "Bado hakuna slips za umma zinazopatikana.",
  communitySlipsBy: "Na",
  communitySlipsSelections: "Selections",
  communitySlipsTotalOdds: "Odds zote",
  communitySlipsLikes: "Likes",
  communitySlipsStake: "Stake",
  communitySlipsExpectedPayout: "Malipo yanayotarajiwa",
  communitySlipsLike: "Like slip",
  communitySlipsLiked: "Ume-like",
  communitySlipsViewHistory: "Tazama historia",
  communitySlipsAuthorHistoryTitle: "Predictions za zamani za {name}",
  communitySlipsAuthorHistoryEmpty: "Bado hakuna historia ya umma ya predictor huyu.",
  communitySlipsCloseHistory: "Funga historia",
  communitySlipsHistoryFailed: "Imeshindikana kupakia historia ya predictor huyu.",
  communitySlipsEdit: "Hariri slip",
  communitySlipsStatusPublished: "Imechapishwa",
  communitySlipsStatusSettled: "Imetatuliwa",
  communitySlipsStatusDraft: "Draft",
  communitySlipsEditingDraft: "Unahariri draft",
  communitySlipsRemovePick: "Ondoa",
  communitySlipsFixtureFallback: "Mechi iliyochaguliwa",
  communitySlipsReasonLabel: "Sababu",
  communitySlipsReasonInput: "Sababu ya pick hii",
  communitySlipsReasonPlaceholder:
    "Hiari: elezea kwa kifupi kwa nini unaamini prediction hii.",
