...
## Build
1. Freeze the north star as a public, read-only football matches and results site modeled on the FotMob web experience observed on March 26, 2026.
...
3. Confirm the product is not a broad sports portal. News, odds, betting funnels, ads, auth, favorites, alerts, social features, and community prediction surfaces are out of MVP scope.
...
5. Lock the data focus to football fixtures, live states, final results, and essential match events only.
