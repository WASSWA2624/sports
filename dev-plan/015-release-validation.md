...
7. Verify consent, ad-slot, odds-gating, region-targeting, affiliate-link routing, analytics-event behavior, and asset host configuration across supported locales, geos, user states, and provider selections.
